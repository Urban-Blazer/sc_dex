...
module srm_dex::test_utils {
  ...
  use srm_dex::btc;
  use srm_dex::usdt::{Self, USDT};
  use srm_dex::eth::{Self, ETH};
  use srm_dex::usdc::{Self, USDC};
  use srm_dex::sc_v_eth_usdc::{Self, SC_V_ETH_USDC};
  use srm_dex::sui_rewards_amm::{Self, Registry};
  ...
  public fun deploy_eth_usdc_pool(test: &mut Scenario, eth_amount: u64, usdc_amount: u64) {
    ...
    next_tx(test, alice);
    {
      ...
      let lp_coin = sui_rewards_amm::new_pool(
        &mut registry,
